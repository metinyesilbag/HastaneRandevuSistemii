...
public class RegisterGUI extends JFrame {
	...
	public RegisterGUI() {
		...
		label.setBounds(10, 11, 151, 21);
		w_pane.add(label);

		fld_name = new JTextField();
		fld_name.setFont(new Font("Yu Gothic Light", Font.BOLD, 13));
		fld_name.setColumns(10);
		fld_name.setBounds(10, 34, 259, 27);
		w_pane.add(fld_name);

		JLabel lblTcNumaras = new JLabel("T.C. Numaras\u0131");
		lblTcNumaras.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 15));
		lblTcNumaras.setBounds(10, 72, 151, 21);
		w_pane.add(lblTcNumaras);

		fld_tcno = new JTextField();
		fld_tcno.setFont(new Font("Yu Gothic Light", Font.BOLD, 13));
		fld_tcno.setColumns(10);
		fld_tcno.setBounds(10, 93, 259, 27);
		w_pane.add(fld_tcno);

		JLabel lblifre = new JLabel("\u015Eifre");
		lblifre.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 15));
		lblifre.setBounds(10, 131, 151, 21);
		w_pane.add(lblifre);

		fld_pass = new JPasswordField();
		fld_pass.setFont(new Font("Yu Gothic UI Light", Font.BOLD, 23));
		fld_pass.setBounds(10, 153, 259, 27);
		w_pane.add(fld_pass);
		...
		btn_register.setBounds(10, 191, 259, 40);
		...
		btn_backto.setBounds(10, 242, 259, 40);
