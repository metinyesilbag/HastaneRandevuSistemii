...
public class DoctorGUI extends JFrame {
	...
	public DoctorGUI(Doctor doctor) throws SQLException {
		...
		select_time.setModel(new DefaultComboBoxModel(new String[] {"10:00", "10:30", "11:00", "11:30", "12:00", "12:30", "13:30", "14:00", "14:30", "15:30"}));
		select_time.setBounds(150, 11, 66, 20);
		...
		btn_addWhour.setBounds(227, 11, 70, 20);
		w_whour.add(btn_addWhour);
		
		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(0, 44, 709, 313);
		...
		btn_deleteWhour.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 10));
		btn_deleteWhour.setBounds(628, 11, 70, 20);
